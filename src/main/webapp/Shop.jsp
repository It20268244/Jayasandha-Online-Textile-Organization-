...
String database = "jayasadha";
String userid = "root";
String password = "maatha";
try {
				...
				<div class="col-sm-3">
					<div class="left-sidebar"><br><br>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="Kids.jsp"><center>Kids</center></a></h4>
								</div>
							</div>
							
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="Shoes.jsp"><center>Shoes</center></a></h4>
								</div>
							</div>
					...
					<div class="features_items"><!--features_items-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									...
									<table border=0></table>
										<img src="images/shop/product123.jpg" alt="" />
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product112.jpg" alt="" />
										<h2>Rs.800</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product102.jpg" alt="" />
										<h2>Rs.600</h2>
										<p> Polo T shirt </p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
...
<!-- --------------------------------------------------------------------------------- --> 
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product33.jpg" alt="" height=300px/>
										<h2>Rs.400</h2>
										<p>Easy Polo Black Edition</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/product-details/product71.png" alt="" height=300px/>
										<h2>Rs.500</h2>
										<p>Easy Polo Black Edition</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/blog/product312.jpeg" alt="" height=300px/>
										<h2>Rs.2000</h2>
										<p>Easy Polo Black Edition</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product11.jpg" alt="" height=300px/>
										<h2>Rs.600</h2>
										<p>Easy Polo Black Edition</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
		...
		<!-- --------------------------------------------------------------------------------- ------->
					...
					<h2 class="title text-center">Item Collection</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										String sql ="select * from shop where ITID= ( select min(ITID) from shop)";
										resultSet = statement.executeQuery(sql);
										while(resultSet.next()){
										%>										
										
										<img src="images/shop/<%=resultSet.getString("itImage") %>" alt="" height=300px/>	
										<h2>Rs.<%=resultSet.getString("itPrice") %></h2>
										<p><%=resultSet.getString("itName") %></p>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										connection = DriverManager.getConnection(connectionUrl+database, userid, password);
										statement=connection.createStatement();
										String sql ="select * from shop where ITID= ( select min(ITID)+1 from shop)";
										resultSet = statement.executeQuery(sql);
										while(resultSet.next()){
										%>										
