			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center">EMPLOYEE ACCOUNT</h2>
					</div>	
				</div>
				
				<h4 class="title text-center">You can login and view your account details and previously applied requests</h4>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="viewEmployeeServlet" method="post">
							<input type="text" name="uname" placeholder="Userame" />
