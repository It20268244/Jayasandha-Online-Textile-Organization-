<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import = "java.util.ArrayList, com.jayasadha.return_refund_management.Orders"%>
			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<%
						...
						ArrayList<Orders> orderList =  (ArrayList <Orders>)session.getAttribute("Orders");
					...
					<!--table row for items-->
						<tr>
							<td class="cart_description">
								<h4>Order <%=currentOrder.getOrderID() %></h4>
								<p>ID :odj00<%=currentOrder.getOrderID() %></p>	
							</td>
								<td class="cart_description">
									<h4><%=currentOrder.getOrderType() %></h4>
								</td>							
								<td class="cart_description">
									<h4><%=currentOrder.getOrderDate()%></h4>
								</td>
								
								<td class = "cart_description">
									<h4><%=currentOrder.getDeliveryStatus() %></h4>
								</td>
								
								<td class = "cart_description">
									<a href = "viewOrder?OID=<%=currentOrder.getOrderID()%>"><button class="btn btn-fefault cart">View Order</button> </a>
								</td>
							</tr>
					<%	}	%>
