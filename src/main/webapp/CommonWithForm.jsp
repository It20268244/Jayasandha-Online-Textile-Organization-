...
<body>
	...
	<tr>
	 ...
	 <tr>
	 	<td>Location ID</td>
	 	<td><input type="text" name="locid" placeholder="Enter value here" pattern="[1-9]{1}" required></td>
	 </tr>
	 <tr>
	 	<td>Delivery Person ID</td>
	  	<td><input type="text" name="delid" placeholder="Enter value here" pattern="[1-9]{1}" required></td>
	  </tr> 
