			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<c:forEach var="search" items="${searchOrder}">
						
						<c:set var="OrderId"      value="${search.getOrderId()}"/>
						<c:set var="OrderDate" 	  value="${search.getOrderDate()}"/>
						<c:set var="AddLine1"     value="${search.getAddLine1()}"/>
						<c:set var="AddLine2"     value="${search.getAddLine2()}"/>
						<c:set var="AddLine3"     value="${search.getAddLine3()}"/>
						<c:set var="CustomerId"   value="${search.getCustomerId()}"/>
						<c:set var="DeliDate"     value="${search.getDeliDate()}"/>
						<c:set var="DeliStatus"   value="${search.getDeliStatus()}"/>
						<c:set var="DeliPerson"   value="${search.getDeliPerson()}"/>
					
						<tr>
							<td class="tbl-border data-align tbl-h">${search.getOrderId()}</td>
							<td class="tbl-border data-align tbl-h">${search.getOrderDate()}</td>
							<td class="tbl-border data-align tbl-h">${search.getAddLine1()}</td>
							<td class="tbl-border data-align tbl-h">${search.getAddLine2()}</td>
							<td class="tbl-border data-align tbl-h">${search.getAddLine3()}</td>
							<td class="tbl-border data-align tbl-h">${search.getCustomerId()}</td>
							<td class="tbl-border data-align tbl-h">${search.getDeliDate()}</td>
							<td class="tbl-border data-align tbl-h">${search.getDeliStatus()}</td>
							<td class="tbl-border data-align tbl-h">${search.getDeliPerson()}</td>
