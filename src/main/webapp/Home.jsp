				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="#"> <span class="pull-right">(56)</span>Mas</a></li>
									<li><a href="#"> <span class="pull-right">(27)</span>Glitz</a></li>
									<li><a href="#"> <span class="pull-right">(32)</span>Brandix</a></li>
									<li><a href="#"> <span class="pull-right">(5)</span>Odel</a></li>
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="images/home/free1.jpg" alt="" />
						</div><!--/shipping-->
