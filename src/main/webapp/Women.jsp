					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="images/cart/product74.jpg" class="girl img-responsive" alt="" height=500px/>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="images/shop/product712.jpg" class="girl img-responsive" alt="" height=500px/>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="images/cart/Product10.jpg" class="girl img-responsive" alt="" height=500px/>
...
<!-- --------------------------------------------------------------------------------- --> 			
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Best Collection - Ladies</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product2134.jpg" alt="" height=300/>
										<h2>Rs.1000</h2>
										<p>Safari Tshirt </p>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product911.jpg" alt="" height=300/>
										<h2>Rs.1200</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/cart/product945.jpeg" alt="" height=300/>
										<h2>Rs.800</h2>
...
<!-- --------------------------------------------------------------------------------- --> 
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product865.jpg" alt="" height=300px/>
										<h2>Rs.1200</h2>
										<p>Easy Polo Black Edition</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/product764.jpg" alt="" height=300px/>
										<h2>Rs.1600</h2>
										<p>Easy Polo Black Edition</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
