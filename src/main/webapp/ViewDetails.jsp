					...
					<div class="left-sidebar">
						...
						<h2>Delete Assignments</h2>
							...
							<table class="tble-width tble-border center">
								...
								<tr>
									<th class="tbl-border data-align tbl-h">Assigned Location ID</th>
									<th class="tbl-border data-align tbl-h">Assigned Delivery Person ID</th>
									<th class="tbl-border data-align tbl-h">Assigned Date</th>
									<th class="tbl-border data-align tbl-h">Action</th>
									
								</tr>
								<c:forEach var="assign" items="${assignDeliveryPersonDetails}">
								
								<c:set var="id"   value="${assign.getLocId()}"/>
								<c:set var="dpid" value="${assign.getDeliveryPersonID()}"/>
								<c:set var="dt"   value="${assign.getAssignedDate()}"/>
							
								<tr>
									<td class="tbl-border data-align tbl-h">${assign.getLocId()}</td>
									<td class="tbl-border data-align tbl-h">${assign.getDeliveryPersonID()}</td>
									<td class="tbl-border data-align tbl-h">${assign.getAssignedDate()}</td>
									<td class="tbl-border data-align tbl-h">
									<c:url value="DeleteAssignment.jsp" var="dltAssi">
									<c:param name="vid"   value="${id}"/>
									<c:param name="vdpid" value="${dpid}"/>
									<c:param name="vdt"   value="${dt}"/>
									</c:url>
										<a href="${dltAssi}">
										<div class="btn-table">
