...
<!-- ------------------------------------------------------------------------------------------------------------- -->
	...
	<form action="itview" method="post" >
	

		<br><br><br>	
		
		<span class="form-label"><h3>Brand OR Category Name</h3> </span>
	
		<input type="text" name="Itname" class="form-control"><br/><br/><br/>
		
	
	
		<input type="submit"name="submit" value="VIEW" class="submit-btn" required>
