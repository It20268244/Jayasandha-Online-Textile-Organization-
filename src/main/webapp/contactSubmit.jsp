	...
	<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center"> <strong> We appreciate your Feedback, and we will respond as soon as possible. </strong></h2>  
                     <center><img  src="images/404/success.png"   alt=""></center>   
                       <p></p>						
