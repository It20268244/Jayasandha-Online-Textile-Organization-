...
<body>
	...
	<center>
		...
		<div class="logo-404">
			<a href="index.html"><img src="images/404/UnsuccessImage1.jpg" alt="" /></a>
		</div>
		
		<h2>Sorry!!!Two days are passed from the day you applied the request.</h2>
		
		<br>
		
		<h2>Therefore you cannot delete this request!!!</h2>
		
		<br>
		
		<h2><a href="viewEmployeeServlet">Bring me back Home</a></h2>
