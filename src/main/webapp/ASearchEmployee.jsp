			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center">SEARCH EMPLOYEE ACCOUNT</h2>
					</div>	
				</div>
				
				<h4 class="title text-center">You can search an employee using the first name</h4>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="SearchEmployeeServlet" method="post">
							...
							<br>						
							<input type="text" name="userFname" placeholder="Employee First Name" />
							<br>
