...
<!-- ------------------------------------------------------------------------------------------------------------- -->
					...
					<div class="form-header">
							...
							<h1><b>Sorry!!!<br/> Not Success!!</b></h1>
							
							<h2>Please Try Again!</h2><br/><br/>
							
							<a href="ItemInsert.jsp"><button type="submit" id=addbtn class="submit-btn"><b>ADD NEW ITEM</b></button><br/><br/></a>
