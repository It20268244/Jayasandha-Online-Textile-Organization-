			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center">ADD EMPLOYEE REQUEST</h2>
					</div>	
				</div>
				
				<h4 class="title text-center">Please fill the form with relevant details and submit</h4>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="RequestInsertServlet" method="post">
							<input type="number" name="empid" min="1" max="50" placeholder="Employee ID" required/>
							<input type="date" name="requiredDate" min="2021-09-13" placeholder="Required Date" required/>
							<input type="text" name="advanceAmount" placeholder="Advance Amount" required/>
