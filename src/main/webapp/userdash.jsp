			...
			<div class="row">
				<div class="col-sm-3">
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center"><b>Supplier Management</b></h2><br><br>
						<h2 class="title1 text-center">Welcome To Jayasandha Supplier Portal!!!</h2><br><br><br><br><br><br><br><br>
					</div>	
				</div>
