...
<meta charset="ISO-8859-1">
	...
	<%
		String message = (String)session.getAttribute("ret_msg");
	%>
	...
	<div class="container text-center">
		...
		<div class="content-404">
			<img src="images/404/success.png" class="img-responsive" alt="" />
			<h1><b>Hooray..!!!</b></h1>
			<p><%=message %></p>
			<h2><a href="cusViewReturn">Get Back To Previous</a></h2>
		</div>
	</div>
