...
<head>
    ...
    <title>Contact Us | Jayasadha</title>
	    	...
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Contact <strong>Us</strong></h2>  
                        <img src="images/contact/inq.jpg" class="contact-map"  alt="">
                       <p></p>						
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			...
	    			<div class="contact-form-2">
	    				<h2 class="title text-center">let's start a Conversation</h2>
	    				<div class="status alert alert-success" style="display: none"></div>
						
				    	<form  action = "insert" method = "get" id="main-contact-form" class="contact-form row" name="contact-form" >
				            <div class="form-group col-md-6">
							    <label for="fname">First name:</label>
				                <input type="text" name="Fname" class="form-control" required="required" placeholder="Anne">
				            </div>
							<div class="form-group col-md-6">
							    <label for="lname">Last name:</label>
				                <input type="text" name="Lname" class="form-control" required="required" placeholder="Marie">
				            </div>
				            <div class="form-group col-md-6">
							      <label for="contact">Contact No:</label>
				               <input type="tel" name="Mobile" class="form-control" pattern="[0-9]{10}" required="required" placeholder="07723456789" >
				            </div>
				            <div class="form-group col-md-12">
							    <label for="typ">Type:</label>
				                <select id = 'type' name = "Inquiry" class="form-control" >
				                <option value="-1" selected>Select..</option>
				                <option value="Information about store">Information about store</option>
		                        <option value="Information about items">Information about items</option>
		                        <option value="About Complains">About Complains</option>
				            ...
				            <div class="form-group col-md-12">
				                <input type="submit" name="submit" class="btn btn-primary pull-right" value="Submit"  onclick="ConfirmInsert()"  >
				            </div>
				        </form>
	    			</div>
	    		</div>
