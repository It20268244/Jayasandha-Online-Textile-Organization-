			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center">ACCEPT EMPLOYEE REQUEST</h2>
					</div>	
				</div>
				
				<h4 class="title text-center">Please click on the button and confirm the acceptance</h4>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<%
							String reqid = request.getParameter("acRqid");
							String empid = request.getParameter("acRqempid");
							String requestedDate = request.getParameter("acRqrequesteddate");
							String requiredDate = request.getParameter("acRqrequireddate");
							String advanceamount = request.getParameter("acRqadvanceamount");
							String reason = request.getParameter("acRqreason");
							String reqstatus = request.getParameter("acRqrqstatus");
						%>
					
					
						<h2> Confirm Accept Request </h2>
						
						<form action="AcceptStatusServlet" method="post">
