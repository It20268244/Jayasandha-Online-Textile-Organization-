			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<br><br>
							...
							<div class="shop-menu1 pull-right">  
								<input type= "text" name="un" placeholder = " supplier name">&nbsp;&nbsp;&nbsp;&nbsp
								<input type = "submit" class="btn-table" name="submit" value="search"> <br>
								</div>
							</form>
						<div>
					      ...
					      <a class="ab" href="editsuplier?id=<c:out value='${sel.SID}' />">Edit</a>
						</td>
				...
				<div>
		            ...
		            <c:forEach var="user" items="${listUser}">
		                <tr>	
		                    ...
		                    <td class="tble-border data-align tble-b" colspan="2">
		                    	<a class="ab" href="editsuplier?id=<c:out value='${user.sid}' />">Edit</a>
