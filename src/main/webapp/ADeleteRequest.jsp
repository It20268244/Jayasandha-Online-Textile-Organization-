			...
			<div class="row">
							...
							<div class="panel panel-default">
								...
								<div id="womens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="viewEmployeeServlet">View my account</a></li>
											<br><br>
											<li><a href="viewPersonalRequestServlet">View my requests</a></li>
											<br><br>	
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center">PERSONAL EMPLOYEE REQUEST</h2>
					</div>	
				</div>
				
				<h4 class="title text-center">You can delete the request only if the request is applied two days before!!!</h4>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<%
							String reqid = request.getParameter("delid");
							String empid = request.getParameter("delempid");
							String requestedDate = request.getParameter("delrequesteddate");
							String requiredDate = request.getParameter("delrequireddate");
							String advanceamount = request.getParameter("deladvanceamount");
							String reason = request.getParameter("delreason");
							String reqstatus = request.getParameter("delrqstatus");
						%>
									
					
						<h2> Confirm Delete Request </h2>
						
						<form action="DeleteRequestsServlet" method="post">
							...
							<input type="text" name="status" value="<%=reqstatus%>" readonly/>
							<br>
