<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import = "java.util.ArrayList, com.jayasadha.return_refund_management.Replacement"%>
<!DOCTYPE html>
<html>
<head>
...
<body>	
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Select Item</h2>
						
						<!-- this is the item view -->
						
	<% 
		ArrayList<Replacement> repList = (ArrayList<Replacement>)session.getAttribute("replacement_list");
	...
	%>
						...
						<div class="col-sm-4"> <!-- start of individual item-->
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>Rs <%=price%></h2>
										<p><%=name %></p>
										<a href = "setRep?name=<%=name%>&price=<%=price%>&image=<%=image%>">
										<button type = "submit" class="btn btn-default add-to-cart"><i class="fa fa-star"></i>Select</button>
										</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>RS <%=price%></h2>
											<p><%=name%></p>
											<a href = "setRep?name=<%=name%>&price=<%=price%>&image=<%=image%>&id=<%=id%>">
											<button class="btn btn-default add-to-cart"><i class="fa fa-star"></i>Select</button>
											</a>
										</div>
									</div>
								</div>
