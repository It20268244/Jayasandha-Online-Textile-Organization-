...
public class CommonConstants {
	...
	public static final String URL = "jdbc:mysql://localhost:3306/amani";

	/** Constant for user name key of MySQL database */
	public static final String USERNAME = "root";

	/** Constant for password key of MySQL database */
	public static final String PASSWORD = "Amani_1221";
	...
	public static final String GET_INACTIVE_CUSTOMER_IDS = "SELECT *FROM Inactive_Customers";
