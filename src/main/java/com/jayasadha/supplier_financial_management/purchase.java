...
public class purchase {
	...
	public purchase( String productid,int suppid, String date, int quantity, float unitprice,String status) {
		super();
	...
	public purchase(int pid,String productid, int suppid, String date, int quantity, float unitprice,String status) {
		super();
		this.pid = pid;
		this.productid = productid;
		this.suppid = suppid;
