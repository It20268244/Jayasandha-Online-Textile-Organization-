...
public class EmployeeDBUtil {
	...
	public static boolean RejectRequest(String ID, String rqStatus) {
		...
		public static List<JobRole> viewJobRoles(){
				
				ArrayList<JobRole> jRole = new ArrayList<>();
				...
				try {
					...
					while(rs1.next()) {
						...
						String bSalary = rs1.getString(3);
						
						JobRole j = new JobRole(rId, Description, bSalary);
